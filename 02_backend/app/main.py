        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    f"{question_list}\n\n"
                    "Return a JSON object with exactly those keys. Each value must be a "
                    "string with the relevant answer, written using the user's own words "
                    "as closely as possible.\n\n"
                    "Rules:\n"
                    "- Do NOT summarize, shorten, or drop details. Include every relevant "
                    "detail, fact, or specific the user mentioned for a topic, even if the "
                    "answer becomes several sentences long.\n"
                    "- Only clean up obvious speech-to-text transcription errors "
                    "(mis-heard words, filler word repetition). Never paraphrase away "
                    "specifics like numbers, names, times, or causes.\n"
                    "- If a sentence is relevant to more than one question, include it in "
                    "full in every relevant field rather than picking just one.\n"
                    "- If a topic is not mentioned at all, use an empty string.\n"
                    "- If the text contains information that does not clearly match any "
                    "of the listed questions, append it to the field it is closest to "
